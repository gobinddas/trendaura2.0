    ...
    <div className='brand-page'>
      <div className='container'>
        <div className='brand-page-content'>
          <h1 className='block-heading'>Trendaura: Where Fashion Meets Everyday Confidence</h1>
          <p className='brand-des'>At Trendaura, we bring you trendy, comfortable, and affordable fashion that fits your lifestyle. We believe in self-expression through style and deliver pieces that empower your everyday look.</p>
          <div className='brand-row'>
           ...
           <p className='brand-des'>Looking ahead, Trendaura aims to expand into sustainable fashion and launch exclusive designer collaborations. We value customer feedback and strive to enhance your shopping experience through innovation, responsive support, and community-driven growth. Join us as we redefine modern style—one confident step at a time.</p>
        </div>
      </div>
    </div>
  )
